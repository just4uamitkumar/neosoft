...
export default function NeoSOFT() {
  return (
    <div className="bg-grey-300 flex flex-col items-center justify-center text-center px-6 py-12 rounded-lg dark:bg-gray-900">
      <header className="max-w-3xl">
        ...
        <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed dark:text-gray-200">
      ...
      >
        <Link
          href="/products1"
          className="text-blue-600 underline-offset-4 decoration-2  hover:underline hover:text-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded transition-all"
        >
          Check Product 1
        </Link>
        <Link
      ...
      <section
        className="gap-6 bg-white dark:bg-gray-900 text-xl sm:text-3xl font-semibold pt-6"
        aria-label="Product navigation details"
      >
        <div className="pb-4 text-left  dark:text-gray-200">
          {" "}
          Product 1 server side rendering
        </div>
